...
function (_Component) {
  ...
  _createClass(RequestRow, [{
    ...
    value: function render() {
      ...
      var ready_to_finalize = request.approvalCount > approversCount / 2;
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Row, {
        disabled: request.complete,
        positive: ready_to_finalize && !request.complete
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = 7;
                return campaign.methods.no_of_contributors().call();
